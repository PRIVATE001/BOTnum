...
ob_implicit_flush(1);
#===۞ABDO𝗜۞===#
$token = "7328496962:AAEbdHsNsIjMbw7b7EB5T-os1OVFl6rDDNo";# توكنك تمام
$tokens = "7328496962:AAEbdHsNsIjMbw7b7EB5T-os1OVFl6rDDNo";
#===۞ABDO===#
...
### ALKINDI ###
$sudo = array("$kindev","1651132769");
$idbot = "7328496962"; #ايدي البوت
$userbot = "Luciferfakebot"; #يوزر البوت بدون @
$userbots = "@$userbot";
$buy = "DF_GD_D"; #معرف المطور بدون @
$chi = "T62RS"; #معرف القناه بدون @
mkdir("sudo");
mkdir("data");
...
bot("sendmessage",[
"chat_id"=>$chat_id,
"text"=>"📬┊› أهلا بك عزيزي [$name](tg://user?id=$id) ؛
☎️┊›بوت الأرقام المجاني يقوم هذا البوت
        بتزويدك بأرقام مجانيه لبعض الدول
        نقوم بتحديث الأرقام بأستمرار

✳️┊› كما يمكنك تفعيل رقم مجاني 
ماذا تنتظر قم بأختيار رقمك الآن🤩
‼️: معاد تحديث الارقام يوم الخميس القادم",
"parse_mode"=>"markdown",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"تصفح قائمة الأرقام📞" ,"callback_data"=>"num"]], 
[["text"=>"تصفح قائمة الأرقام📞 2" ,"callback_data"=>"num1"]], 
[["text"=>"تصفح قائمة الأرقام📞 3" ,"callback_data"=>"num2"]], 
[["text"=>"تصفح قائمة الأرقام📞 4" ,"callback_data"=>"num3"]], 
[["text"=>"قسم ارقام جديد" ,"callback_data"=>"wat"]], 
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
$ra=rand(1,20);
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"تغيير الرقم ⚔️" ,"callback_data"=>"num"]],
[["text"=>"اطلب الكود📬" ,"callback_data"=>"code#$ex[3]"]], 
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
...
bot("sendmessage",[
"chat_id"=>$chat_id2,
"text"=>"🎖 | ›شكرا لاستخدامك البوت🎉 

📟 | › إسم التطبيق+ الكود ↓↓↓
 $ex[1]

⏱ | › آخر تحديث لطلب الكود ↓↓↓
$ex[3]"
]);
}
}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"تغيير الرقم ⚔️" ,"callback_data"=>"num1"]],
[["text"=>"اطلب الكود📬" ,"callback_data"=>"rt#$ex[3]"]],
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
...
📛┊› ملاحظة لاتقم بطلب الكود قبل إدخال    الرقم حتى لايقوم البوت بإرسال نتيجة خاطئ
 للعوده اضغط /start ",
"parse_mode"=>"markdown",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"تغيير الرقم ⚔️" ,"callback_data"=>"num2"]],
[["text"=>"اطلب الكود📬" ,"callback_data"=>"mn#$ex[3]"]],
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
...
$ra3=rand(1,20);
$Api3 = file_get_contents("https://getfreesmsnumber.com/?page=4");

$num3=explode('<h3 class="p-0 m-0">',$Api3);
$nu3=filter_var($num3[$ra3],FILTER_SANITIZE_STRING);
$str=str_replace(" ","",$nu3);
$ex=explode("\n",$str);
if($data=="num3"){
bot('EditMessageText', [
...
"inline_keyboard"=>[
[["text"=>"تغيير الرقم ⚔️" ,"callback_data"=>"num2"]],
[["text"=>"اطلب الكود📬" ,"callback_data"=>"nb#$ex[3]"]],
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
...
}else{$app=file_get_contents("https://getfreesmsnumber.com/virtual-phone/p-$nb[1]");
$ex=explode('<div class="card-body" style="padding:1em;">',$app);
$nb=explode('</footer>',$ex[1]);

$filter=filter_var($nb[0], FILTER_SANITIZE_STRING);
$str=str_replace(" ","  ",$filter);
$str=str_replace("  "," ",$filter);
$ex=explode("\n",$str);
bot("sendmessage",[
...
"inline_keyboard"=>[
[["text"=>"تغيير الرقم ⚔️" ,"callback_data"=>"num2"]],
[["text"=>"اطلب الكود📬" ,"callback_data"=>"cv#$ex[3]"]],
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
...
bot('EditMessageText', [
      'chat_id' => $chat_id2,
      'message_id' => $mid2,
 'text' =>"📬┊› أهلا بك عزيزي في
 
قسم ارقام جديد الارقام تعمل بنسبه 80٪

✳️┊› يمكنك تفعيل رقم مجاني 
ماذا تنتظر قم بأختيار رقمك الآن🤩",
"parse_mode"=>"markdown",
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"قسم ارقام 1" ,"callback_data"=>"nue"]], 
[["text"=>"قسم ارقام 2" ,"callback_data"=>"nuw"]], 
[['text'=>"DEV",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"تغيير الرقم ⚔️" ,"callback_data"=>"nue"]],
[["text"=>"اطلب الكود📬" ,"callback_data"=>"nk#$ex[3]"]],
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
...
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[["text"=>"تغيير الرقم ⚔️" ,"callback_data"=>"nuw"]],
[["text"=>"اطلب الكود📬" ,"callback_data"=>"nf#$ex[3]"]],
[['text'=>"😎┇مطور البوت 🛠",'url'=>"https://telegram.me/DF_GD_D"]]
]])
]);
}
